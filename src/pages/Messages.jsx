...
import { ArrowLeft, Shield, Paperclip, Smile, SmilePlus, Mic, Send, Link2, X, FileText, Search, ExternalLink, Download, Pencil, Trash2 } from 'lucide-react';
...
export default function Messages({
  ...
  async function submit() {
    ...
    setSending(true);
    const ok = await onSend({ text: text.trim(), linkedEventId: linkedEvent ? linkedEvent.id : null });
    setSending(false);
    if (ok) setText('');
  }
